...
DEF_TRAVERSE_TYPE(TMVarType, { TRY_TO(TraverseType(T->getValueType())); })
...
DEF_TRAVERSE_TYPELOC(TMVarType, { TRY_TO(TraverseTypeLoc(TL.getValueLoc())); })
...
// GNU TM Extension
DEF_TRAVERSE_STMT(TransactionAtomicStmt, {})
